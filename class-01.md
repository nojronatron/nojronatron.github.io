...
- Determine what *Events* will happen and what (if anything) to do when they happen.  
- Create *Methods* that will act on Properties based on Events.  
...
- JS is an *interpreted language* meaning each line of code is executed one by one.
